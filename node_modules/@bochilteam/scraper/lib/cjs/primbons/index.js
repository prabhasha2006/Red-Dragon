...
const artimimpi_js_1 = __importDefault(require("./artimimpi.js"));
exports.artimimpi = artimimpi_js_1.default;
const artinama_js_1 = __importDefault(require("./artinama.js"));
exports.artinama = artinama_js_1.default;
const nomorhoki_js_1 = __importDefault(require("./nomorhoki.js"));
exports.nomorhoki = nomorhoki_js_1.default;
const zodiac_js_1 = __importDefault(require("./zodiac.js"));
