...
⭐✑ من فضلك اقراء شروط وقوانين القروب. ...: ${metadata.desc}

⭐✑ مرحبًا بكم في القروب يرجى الالتزام بقوانين القروب او سيتم ازالتك تلقائيا بواسطة بوت الحمايه 🖤🤖`} )
                } else if (anu.action == 'remove') {
                    RedDragonMdNx.sendMessage(anu.id, { image: Tol, contextInfo: { mentionedJid: [num] }, caption: `⭐✑ @${num.split("@")[0]} غارد 😢 ${metadata.subject}
