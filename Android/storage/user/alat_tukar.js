  const fs = require('fs')
  let _inventoryOrang = JSON.parse(fs.readFileSync('./Android/storage/user/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./Android/storage/user/inventory.json', JSON.stringify(_inventoryOrang))
   }
