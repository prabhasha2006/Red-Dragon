...
هذي رساله طلب الشراء\n\n: ملابس نسائية داخليه كلسون و سنتيانه لون احمر رقم المنتج  213${text}` })
            return reply(`تم ارسال طلب الشراء الى البائع\n\nمن فضلك يرجى الانتظار و التحلي بالصبر الى ان يتم الرد عليك من قبل البائع \n\n شكرا لاستخدامكم بوت ميزو لخدمات الواتس اب و الرد التلقائي 🤖`)
                    ...
                    break
        //chat bot\\
            case 'مساعده': { RedDragonMdNx.sendMessage(from, { text: `*هنعرض لحضرتك المميزات بشكل بسيط وكل ميزة تحتها وصف بسيط ليها

🔶 ارسال رسائل تسويقية و حملات إعلانية لجميع عملائك📣
هتقدر من خلال الموقع انك ترسل رسائل لعملاءك عن طريق الموقع بدون جهاز كمبيوتر ولا موبيل شغال 24 ساعة وتجدول الرسائل فى الوقت المناسب لك
...
🔶الرد الآلي علي عملاءك بناءا علي اسئلتهم 
 هتقدر من خلال الموقع انك تعمل بوت يرد تلقائي علي عملاءك بناءا علي اسئلتهم وكلماتهم المفتاحيه ويمكنك عمل زراير وقائمة لجعل عملية الشات بوت اكثر سهولة
☑  الرد ارسال نص او صورة او فيديو او فويس نود او كلهما مع بعض
☑يمكنك الرد ارسال رسالة نص + ازرار
☑ يمكنك الرد ارسال رسائل نص + قائمة
☑ يمكنك نقل الشات بوت الى اكثر من رقم خاص بك  بكل سهولة

🔶 رسالة الرد الآلي التلقائي على العملاء
 يمكنك عمل رد تلقائي للعملاء او رسالة ترحيبيه  
☑  الرد ارسال نص او صورة او فيديو او فويس نود او كلهما مع بعض
☑يمكنك الرد ارسال رسالة نص + ازرار
☑ يمكنك الرد ارسال رسائل نص + قائمة
...
ملحوظة هامة: هذة برمجة متطورة لتحسين خدمة الواتساب وليس api رسميا للواتساب*` }, { quoted: m }) 
            ...
            break
            case 'بوت': { RedDragonMdNx.sendMessage(from, { text: `*مرحبا بكم انا بوت ميزو لخدمات الواتس و الرد التلقائي  يرجى ارسال كلمه مساعده للحصول على تعليمات استخدام البوت *` }, { quoted: m }) 
            } 
            break
