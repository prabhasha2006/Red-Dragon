...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`
            ...
            break
            case 'chat': case 'دردشه': case 'دردشة': {
             ...
             case 'hornycheck':
                 case 'prettycheck':
                    case 'lovelycheck':
                      case 'uglycheck':
                             case 'الحب':
				if (!text) return replay(`منشن على اي حد تبغا تقيس مدى الحب لك او اكتب اسم الشخص, مثال : ${prefix + command} @مازن`)
...
case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh': case 'كيفك':
	...
	break
		...
		await RedDragonMdNx.updateBlockReportActivityStatus(users, 'report').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
case 'reportss': {
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net/nReport!'
		await RedDragonMdNx.updateBlockReportActivity(users, 'report').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
...
let teks = `╚»·٠•●♥❮❮ جميع الأعضاء ❯❯♥●•٠·«╝ 
 ...
 ➲ *Message : ${q ? q : 'لا توجد رسائل'}*\n\n`
            ...
            break
	    case 'style': case 'styletext': case 'الخط': case 'خطوط': {
...
break
case 'تعليم': case 'تعلم': case 'اتعلم': case 'علمني': case 'المجال': case 'مجال': {
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    sections: [{	
								...
								"rows": [
									{
										"title": "نسخ و اتس ضد الفيروسات",
										"description": "افضل نسخ ضد الفيروسات محدثه اخر اصدار",
										"rowId": `${prefix}نواتس`
									},
									{
										"title": "كود فك الحظر",
										"description": "افضل كود فك الحظر مجرب",
										"rowId": `${prefix}كفحظر`
										},
									{
										"title": "اختراق واتساب",
										"description": "طريقة اختراق الواتس و مراقبه اي حد في الواتساب",
										"rowId": `${prefix}اواتس`
										},
									{
										"title": "ارقام وهميه",
									...
									{
										"title": "ملف سرعه",
										"description": "ملف سرعه فيه اقوى الفيروسات حرق نسخ",
										"rowId": `${prefix}مواتس`
									},
									{
										"title": "تطير ارقام واتس",
										"description": "طرق تطير ارقام واتس المزعجين",
										"rowId": `${prefix}تواتس`
									},
										{
											"title": "برمجه نسخ واتس",
										"description": "كيفية تعديل و تطوير و برمجه نسخ واتساب باسمك",
										"rowId": `${prefix}بواتس`
										}
								]
							},
							{
								"title": "قسم الاختراق و المراقبة",
								"rows": [
									{
										"title": "اختراق كمبيوتر",
										"description": "طرق اختراق الكمبيوتر بستخدام تيرمكس",
										"rowId": `${prefix}اكمبيوتر`
									},
									{
										"title": "اختراق الجوال",
										"description": "طرق اختراق الجوال بستخدام تيرمكس",
										"rowId": `${prefix}اجوال`
										},
									{
										"title": "اختراق مواقع",
										"description": "طرق اختراق المواقع بستخدام تيرمكس",
										"rowId": `${prefix}امواقع`
										},
									{
										"title": "اختراق حسابات",
										"description": "طرق اختراق حسابات مواقع تواصل الاجتماعي ",
										"rowId": `${prefix}احسابات`
									},
									{
										"title": "تهكير اللعاب",
										"description": "طرق تهكير الاللعب و زياده الاسلحه و المجوهرات",
										"rowId": `${prefix}تالعاب`
									},
									{
										"title": "برامج مدفوعه",
										"description": "برامج مدفوعه  بفلوس احصل عليها مجانا",
										"rowId": `${prefix}بمدفوعه`
									},
									{
											"title": "ملف فرمته",
										"description": "طريقة فرمته جوال اي شخص يهددك",
										"rowId": `${prefix}مفرمته`
										}, 
										{
											"title": "هندسة الاجتماعية",
										"description": "طرق الهندسة الاجتماعية و تهكير العقول و اقناع الضحيه",
										"rowId": `${prefix}هاجتماعيه`
										}
								]
							},
							{
								"title": "قسم التصاميم و المنتاج",
								"rows": [
									{
										"title": "تصاميم صور",
										"description": "طرق تصاميم صور خرافيه ",
										"rowId": `${prefix}تصور`
									}
								]
							},
							...
							"title": "قسم البرمجة",
								"rows": [
									{
										"title": "لغه بايثون",
										"description": "كورس تعلم برمجه لغه بايثون من الصفر للاحتراف",
								"rowId": `${prefix}لبايثون`
									}
								]
							}
						],
...
case 'كفحظر': {
                ...
                let buttons = [
                    {buttonId: `${prefix}كفتخمين`, buttonText: {displayText: '❮❮فك حظر تخمين❯❯'}, type: 1}, {buttonId: `${prefix}كفاباحي`, buttonText: {displayText: '❮❮كود فك حظر اباحي ❯❯'}, type: 1}, {buttonId: `${prefix}كفانتهاك`, buttonText: {displayText: '❮❮فك حظر انتهاك❯❯'}, type: 1}]
                let buttonMessage = {
                    image: { url: 'https://i.ibb.co/rMRtSFJ/IMG-20220805-WA0009.jpg'},
                caption: `-☬ بكم في بوت ميزو 🤖࿐\n\nمرحبا, ${pushname}\n\n┏━❯ *${botname}* ❮━😎\n┃
┃╔══☯︎❯ تعليمات ❮ 👇
┃║ 
*احفظ رقم البوت واضفه الى قروبك* ورفعه ادمن لحمايه قروبك من الرسايل المزعجيه او السب و الشتم و الروابط 
يمكنك التحكم في البوت ترسل امر و البوت ينفذ الأوامر 🤖
البوت مربوط بموقع يرد تلقائي 24 ساعه بردود تلقائيه وكل يوم منشورات مفيده💱
┃║ 
┃╚═══════✍︎☬
...
Зональная сеть M зона N X зона N M зона MXX XXXKN

الــــرســــاله

四区四四四四四四四四四四四四四四四四四四四四四四四Whatsapp四四四四四四四四四四四四四四四四四四四四四四四四whatsapp四四四四四四四四四四四四四四四四四四四四四四四四四四元+967
...
هذي رساله طلب الشراء\n\n: ملابس نسائية داخليه كلسون و سنتيانه لون احمر رقم المنتج  213${text}` })
            return reply(`تم ارسال طلب الشراء الى البائع\n\nمن فضلك يرجى الانتظار و التحلي بالصبر الى ان يتم الرد عليك من قبل البائع \n\n شكرا لاستخدامكم بوت ميزو لخدمات الواتس اب و الرد التلقائي 🤖`)
                    ...
                    break
        //chat bot\\
            case 'مميزات': { RedDragonMdNx.sendMessage(from, { text: `نعرض لك المميزات بشكل بسيط وكل ميزة تحتها وصف بسيط لها

✅ *ارسال رسائل تسويقية و حملات إعلانية لجميع عملائك📣*
تقدر من خلال البوت انك ترسل رسائل لكل عملاءك عن طريق البوت و بدون جهاز كمبيوتر ولا موبيل شغال 24 ساعة وتجدول الرسائل فى الوقت المناسب لك
☑   يمكنك ارسال نص او صورة او فيديو او فويس نود او كلهما مع بعض
☑يمكنك ارسال رسالة نص + ازرار
☑ يمكنك ارسال رسائل نص + قائمة
☑ يمكنك ارسال رسائل باسم العميل 🤵

🔶الرد الآلي علي عملاءك بناءا علي اسئلتهم 
 تقدر من خلال البوت انك تعمل رد تلقائي علي عملاءك بناءا علي اسئلتهم وكلماتهم المفتاحيه ويمكنك عمل زراير وقائمة لجعل عملية الشات بوت اكثر سهولة

🔶 رسالة الرد الآلي التلقائي على العملاء
 يمكنك عمل رد تلقائي للعملاء او رسالة ترحيبيه رساله او صورة او فويس نود او فيديو او كلهما مع بعض
...
┃╔══☯︎❯ تعليمات ❮ 👇
┃║ 
~نعرض لك المميزات بشكل بسيط وكل ميزة تحتها وصف بسيط لها~
...
ملحوظة هامة💯💯💯: هذة برمجة متطورة لتحسين خدمة الواتساب وليس api رسميا للواتساب
┃║ 
┃╚═══════✍︎☬
┗━❯ *مطور البوت ${ownername}*  ━😎`,
                footer: RedDragonMdNx.user.name,
...
┃╔══☯︎❯ تعليمات ❮ 👇
┃║ 
*اضف البوت الى قروبك* ورفعه ادمن لحمايه قروبك من الرسايل المزعجيه او السب و الشتم و الروابط 
يمكنك التحكم في البوت ترسل امر و البوت ينفذ الأوامر 🤖
فيه امر تنزيل الاغاني🎼 
و فيديوهات🎥
 و صور📸
 وبرامج🖲️
 يتم تنزيل بثواني بدون ماتخسر نت ولا شيء 
فيه امر فتح واغلاق القروب بوقت تحدده انت 
و امر انشاء رابط 
فيه امر ازاله 
امر اضافه
فيه امر بلاغات 
فيه امر تحذير اي عضو اكثر من ثلاث مرات ينحذف تلقائي 
فيه امر حمايه القروب حذف السب و الشتم و روابط اي حد يرسل روابط يتم حذفه تلقائي 
فيه امر تصاميم 
و امر تصويت
و اللعاب
و تعليم الانجليزي 🇦🇺
و امر تحويل صورة او فيديو الى ملصق و العكس 
فيه اذاعه 📢
فيه ردي تلقائي على الأعضاء 
مثلا حد يبغا روايه او اغنيه او فيديو يرسلها له بثواني 
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            break
            case 'مضاد': case 'ضد': { RedDragonMdNx.sendMessage(from, { text: `مضاد فيروسات بواسطة بوت ميزو 🤖☠️
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
مضاد فيروسات بواسطة بوت ميزو 🤖☠️
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
مضاد فيروسات بواسطة بوت ميزو 🤖☠️
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥
⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥⛓🔥⛓🔥⛓🔥 ▄▇▇▇▇▇▇▇▇▇▄𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦✦͜͜͜͜͡͡͡𖣘⃢▓҈҉𖣔⃢▓҈҉𖣘⃢▓҈҉𖣔⃢▓҈҉͜͜͜͜͡͡͡✦⚙🇦🇱مضاد🔧فيروس🇦🇱⚙ ⛓🔥` }, { quoted: m }) 
            } 
            break
...
*ٳﻗـ☜ـࢪب ﺻـً😍ـًﻟيٳآ شــآحبك❥**` }, { quoted: m })
            ...
            break
case 'هلا': {
                RedDragonMdNx.sendMessage(from, { text: `*​هـٍْـٍْـــــــــ﴿😸﴾ـٌٍْـــــــٍْـٍٍْْلا« ☻💕↯☂*
*هَــْـِْـْْـِلاّ بشاحن روح͡ـ♡ــيے*
*❤ونضارت قلـ̮ــــ̮ـــــــبٰي*
*💔وسماعت عيــ٭ٰ۬ۛﹻ٭ٰ۬ۛﹻــوني*
*❤واكسجين فمـــ٭ٰ۬ۛﹻ٭ٰ۬ۛﹻــي*
*💔والاتريك حقـــ٭ٰ۬ۛﹻ٭ٰ۬ۛﹻــــــي*
*❤ونبـــــض بطنـــ٭ٰ۬ۛﹻ٭ٰ۬ۛﹻــي*
*😸ويـ٭ٰ۬ۛﹻ٭ٰ۬ۛﹻــش ازيد ‏​‏​​‏​​أقـِْ♡̬̩̃ ̷̴ـِْۈۋۈل☻*` }, { quoted: m })
            }
            break
            ...
            break
            case 'halo': case 'hello': case 'haloo': case 'හලො': case 'හලෝ': case 'හලූ': case 'جديد': {
