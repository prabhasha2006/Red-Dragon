...
مرحبا بكم في بوت ميزو للخدمات التجاريه و الردود التلقائيه يرجى اختيار مايناسبك`,unicorn, [{"urlButton": {"displayText": `${button}`,"url": `${btnurl}`}},{"urlButton": {"displayText": "للتواصل معا مدير المبيعات","url": `https://wa.me/message/QEKSD67VFST6H1`}},{"quickReplyButton": {"displayText": "قسم النسائيه","id": 'sellerm'}},{"quickReplyButton": {"displayText": "قسم الرجالي","id": 'sellermm'}},{"quickReplyButton": {"displayText": "قسم الاطفال","id": 'sellermmm'}}] )
break
case 'بووت': { let buttons = [ {buttonId: `${prefix}تعليم`, buttonText: {displayText: '❮❮💰الربح من الانترنت💰❯❯'}, type: 1}, {buttonId: `${prefix}شكرا`, buttonText: {displayText: '❮❮📽تصاميم📽❯❯'}, type: 1}, {buttonId: `${prefix}تعليم`, buttonText: {displayText: '❮❮💰الربح من الالعاب💰❯❯'}, type: 1}, {buttonId: `${prefix}تعليم`, buttonText: {displayText: '❮❮💰الربح من الاعلانات💰❯❯'}, type: 1}, {buttonId: `${prefix}ارقام`, buttonText: {displayText: '❮❮☠اختراق☠❯❯'}, type: 1}] let buttonMessage = { image: { url: 'https://i.ibb.co/rMRtSFJ/IMG-20220805-WA0009.jpg'}, caption: `-☬ بكم في بوت ميزو 🤖࿐\n\nمرحبا, ${pushname}\n\n┏━❯ *${botname}* ❮━😎\n┃┃╔══☯︎❯ تعليمات ❮ 👇┃║ 
